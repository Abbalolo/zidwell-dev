...
{/* 
          ...
          <div className="flex items-center justify-center space-x-4 pt-4">
            <Button onClick={() => router.push("/dashboard/services/fund-account")} className="bg-[#C29307] hover:bg-[#C29307] text-white px-8 py-3">
              <Plus className="w-4 h-4 mr-2" />
              Add Money
            </Button>
            <Button variant="outline" onClick={() => router.push("/dashboard/transactions")} className="px-8 py-3 bg-transparent">
